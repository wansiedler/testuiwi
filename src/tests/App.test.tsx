...
import { sizes } from "../uiwiwidget/types";
...
import { fetchMetaExperimentId } from "../uiwiwidget/quizAction";
...
beforeEach(() => {
      ...
      fetchMock.doMock();
      // jest.spyOn(fetchMetaExperimentId).mockImplementation(() => new Promise((res) => setTimeout(() => res({}), 200)));
});
